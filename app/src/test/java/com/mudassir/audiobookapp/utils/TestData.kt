...
import com.mudassir.audiobookapp.model.Authors
...
object TestData {
    ...
    = ListenHubAudioBooksModel(authors, chapterCount, chapters, description, genres, id, imageUrl, language, title, totaltime, totaltimesecs, url_zip_file)

   internal fun getAudioBookResponse(listenHubAudioBooks: List<ListenHubAudioBooksModel> = listOf(
       getListenAudioBook()
   )) =
       AudioBookModel(listenHubAudioBooks)
