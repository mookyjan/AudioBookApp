...
import com.mudassir.data.local.mapper.AudioBookLocalToDomainMapper
...
class AudioBookGateWayImpl (private val audioBookRepository: AudioBookRepository): AudioBookGateWay{
    ...
    override fun getAudioBookList(refresh: Boolean?): Single<AudioBookEntity> {
        ...
        return audioBookRepository.getAudioBookList(refresh).map {
            AudioBookLocalToDomainMapper.transformTo(it)
        }
    }
